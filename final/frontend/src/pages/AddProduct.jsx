    ...
    <>
      {tokenExist && (
        <>
          ...
          <h1 className="text-xl font-semibold font-content text-primecolor mt-2">Add your new product here</h1>
          </div>
          <div className="flex justify-center mt-6">
            <div className="flex flex-col">
              <form onSubmit={handleSubmission} className=" bg-orange-100 p-7 rounded-lg">
                <label className="text-l font-semibold font-content text-primecolor mr-3" for="productName">Product Name: &nbsp;</label>
                <input
                ...
                <div className="flex flex-row">
                  <div className="flex flex-row">
                    <label className="text-l mt-4 mr-4 font-semibold font-content text-primecolor" for="productName">Category: &nbsp;</label>
                    <select
                  ...
                  <div className="flex flex-row">
                    <label className="text-l font-semibold font-content text-primecolor ml-56" for="productName">
                      Sub Category: &nbsp;
                    </label>
                    <select
                ...
                <div className="flex flex-row">
                  <label className="text-l font-semibold mt-3 font-content text-primecolor" for="productMrp">MRP: &nbsp;</label>
                  <input
                  ...
                  />
                  <br></br>
                  <label className="text-l font-semibold font-content mt-3 text-primecolor ml-16" for="productWeight">
                    Weight: &nbsp;
                  </label>
                  <input
                ...
                <div className="flex flex-row">
                  <label className="text-l font-semibold font-content mt-3 text-primecolor" for="productdescription">Description: &nbsp;</label>
                  <input
                  ...
                  />
                  <br></br>
                  <label className="text-l mt-3 font-semibold font-content text-primecolor ml-16" for="productstock">
                    Stock: &nbsp;
                  </label>
                  <input
                ...
                <div className="flex flex-row">
                  <label className="text-l font-semibold font-content mt-3 text-primecolor" for="productstock">Botanical Name: &nbsp;</label>
                  <input
                    className="w-96 shadow-md rounded py-2 px-3 mt-1 mb-4 bg-gray-50 font-content  focus:outline-brown"
                    type="text"
                  ...
                  />
                  <br></br>
                  <label className="text-l font-semibold mt-3 font-content text-primecolor ml-16" for="productstock">
                    Tamil Name: &nbsp;
                  </label>
                  <input
                    className="w-96 shadow-md rounded py-2 px-3 mt-1 mb-4 bg-gray-50 font-content  focus:outline-brown"
                ...
                <div className="flex flex-row">
                  <label className="text-l font-semibold font-content mt-3 text-primecolor" for="productstock">Discount Price: &nbsp;</label>
                  <input
                  ...
                  />
                  <br></br>
                  <label className="text-l font-semibold mt-3 font-content text-primecolor ml-16" for="productTax">
                    Tax: &nbsp;
                  </label>
                  <input
                ...
                <div className="flex flex-row">
                  <label className="text-l font-semibold font-content mt-3 text-primecolor" for="productImage">Product Images: &nbsp;</label>
                  <input
                  ...
                  />
                  <br></br>
                  <label className="text-l font-semibold mt-3 font-content text-primecolor ml-10" for="productImage">
                    Cover Image: &nbsp;
                  </label>
                  <input
